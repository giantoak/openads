...
public class AttributeLocation {
	...
	private static void initTable() {
		...
		if (db.tableExists(ATTRIBUTE_LOCATION_TABLE)) {
			System.out.println("Clearing table: " + ATTRIBUTE_LOCATION_TABLE);
			db.clearTable(ATTRIBUTE_LOCATION_TABLE);
		} else {			
	...
	private static void getAttributeLocations(int startAttrId, int endAttrId,
		...
		HashMap<Integer,HashSet<Integer>> adsToAttributes = new HashMap<Integer,HashSet<Integer>>();
		ArrayList<Integer> ads = new ArrayList<Integer>();
		AttributeDetails.getAdsInAttributes(startAttrId, endAttrId, allAttributes, adsToAttributes, oculusconn, htconn, ads);
